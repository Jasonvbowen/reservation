...
public class ViewerGUI extends JFrame {
        ...
        new Thread() {
            ...
            public void run() {
                while (true) {
                    ...
                    clock.setText(CurrentDate() + " Time: " + hour + ":" + minute + ":" + second + " " + Day_Night);
    ...
    private void setGUI() {
        ...
        ImageIcon icon = new ImageIcon(Toolkit.getDefaultToolkit().getImage(getClass().getResource(("hotel.png"))));
        ...
        startButton = new JRadioButton("Search by: Letter the Name Starts With");
        ...
        buttonPanel.setBorder(BorderFactory.createTitledBorder("Search for Customer's Name"));
    ...
    private void loadBinary() {
        ...
        chooseFile.setCurrentDirectory(binaryFile.getAbsoluteFile().getParentFile());
        FileFilter filter = new ExtensionFileFilter(".dat- Binary File ", new String[]{"dat"});
            ...
            if (event.getSource() == quitItem) {
                ...
                try {
                    ...
                    if (wholeButton.isSelected()) {
                        found = Search.binarySearch(dataArray, custName.getText());
                    } else if (startButton.isSelected()) {
                        found = Search.binarySearchFirstLetter(dataArray, custName.getText().charAt(0));
                    }
